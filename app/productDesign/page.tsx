...
function ProductDesignContent() {
  ...
  // Derive values directly from searchParams instead of storing in state
  ...
  // Use lazy initializer to create initial message only once on mount
  const [messages, setMessages] = useState<Message[]>(() => {
    if (productTitle) {
      return [{
        id: Date.now(),
        text: `I can help you with design ideas for "${productTitle}". What would you like to know or modify?`,
        sender: 'bot' as const,
        timestamp: new Date()
      }];
    }
